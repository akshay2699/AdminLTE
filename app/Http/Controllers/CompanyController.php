...
class CompanyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            if($request->ajax()){
                ...
                $btn= '<a href="javascript:void(0)" data-toggle="tooltip" data-id="'.$row->id.'" data-original-title-="Edit" class="edit btn btn-primary editCompany" id="editCompany">Edit</a>';
    ...
    public function store(Request $request)
    {
        ...
        $data = ['name' => $request->name, 'email' => $request->email, 'website' => $request->website, 'logo' => $request->logo];
